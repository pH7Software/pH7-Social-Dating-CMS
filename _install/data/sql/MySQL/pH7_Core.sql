...
CREATE TABLE IF NOT EXISTS ph7_members (
  ...
  lastName varchar(50) DEFAULT NULL,
  birthDate date NULL,
  sex enum('buyer','seller') NOT NULL DEFAULT 'buyer',
...
('defaultSysModule', 'realestate', 'The default module running by default on the index page. Recommended to keep the "user" module', 'general'),
...
('userActivationType', 1, '1 = no activation, 2 = email activation, 3 = manual activation by administrator, 4 = SMS activation', 'registration'),
