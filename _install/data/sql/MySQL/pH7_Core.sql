...
-- Set the variables --
--
SET @sDefaultSiteName = 'Acquireutah';
...
CREATE TABLE IF NOT EXISTS ph7_members_info (
  ...
  propertyHomeStyle enum('rambler', 'ranch', 'tri-multi-level', 'two-story', 'other') NOT NULL DEFAULT 'other',
...
('en_US', 'Home', 'The Real Estate Community', 'real estate, community, house, rent, sell, seller, buyer', 'Where Home Buyers and Sellers meet', 'The Place to Buy and Sell Properties', 'You are in the right place to buy, or sell and sell your home.', 'index, follow, all', '', 'All Rights Reserved.', 'general', 'global', 'real estate');
...
('Photo', 'picture', '0', '1'),
('Video', 'video', '0', '1'),
('Hot or Not', 'hotornot', '0', '0'),
('Forum', 'forum', '0', '0'),
('Note (blog for users)', 'note', '0', '0'),
('Blog (company blog)', 'blog', '0', '1'),
('Love Calculator', 'love-calculator', '0', '0'),
