...
('backgroundColor', '', 'Overwrite background color. Leave empty to disable', 'design'),
('textColor', '', 'Overwrite text color. Leave empty to disable', 'design'),
('linkColor', '', 'Overwrite links color. Leave empty to disable', 'design'),
('footerLinkColor', '', 'Overwrite footer links color. Leave empty to disable', 'design'),
('linkHoverColor', '', 'Overwrite links hover color. Leave empty to disable', 'design'),
