...
<p>
    <span class="bold">{$LANG.will_you_make_donation}</span> <a href="{$patreon_url}" data-patreon-widget-type="become-patron-button" target="_blank" rel="noopener noreferrer">{$LANG.donate_here}</a>.<br />
