...
<form method="post" action="{$smarty.const.PH7_URL_SLUG_INSTALL}config_system">
    <fieldset>
        ...
        <p>
            ...
            <input type="text" name="db_hostname" id="db_hostname" onfocus="if ('localhost' == this.value) this.value='';" onblur="if ('' == this.value) this.value = 'localhost';" value="{$smarty.session.db.hostname|escape}" required="required" />
        </p>

        <p>
            <span class="mandatory">*</span> <label for="db_username">{$LANG.db_username}:</label><br />
            <input type="text" name="db_username" id="db_username" onfocus="if ('root' == this.value) this.value='';" onblur="if ('' == this.value) this.value = 'root';" value="{$smarty.session.db.username|escape}" required="required" />
        </p>
        ...
        <p>
            ...
            <input type="text" name="db_name" id="db_name" onfocus="if ('ph7cms' == this.value) this.value='';" onblur="if ('' == this.value) this.value = 'ph7cms';" value="{$smarty.session.db.name|escape}" required="required" />
        </p>
        ...
        <p>
            ...
            <input type="text" name="db_charset" id="db_charset" onfocus="if ('UTF8' == this.value) this.value='';" onblur="if ('' == this.value) this.value = 'UTF8';" value="{$smarty.session.db.charset|escape}" required="required" />
        </p>

        <p>
            <span class="mandatory">*</span> <label for="db_port">{$LANG.db_port}:</label><br />
            <span class="small">{$LANG.desc_db_port}</span><br />
            <input type="text" name="db_port" id="db_port" onfocus="if ('3306' == this.value) this.value='';" onblur="if ('' == this.value) this.value = '3306';" value="{$smarty.session.db.port|escape}" required="required" />
        </p>
