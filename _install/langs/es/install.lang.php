...
$LANG = array(
    ...
    'conform_to_laws' => 'Estoy de acuerdo en mantener siempre mi sitio web totalmente legal, cumplir con cualquier ley aplicable que pueda aplicarse a mí, a mi sitio web y a sus usuarios, y verificar y <a href="https://ph7cms.com/doc/en/how-to-edit-the-static-and-legal-pages" target="_blank" rel="noopener">actualizar los "Términos" la "Política de privacidad"</a> y cualquier otra página legal necesaria para cumplir plenamente con las leyes y regulaciones aplicables.',
    'responsibilities_agreement' => 'Acepto usarlo bajo mi propio riesgo y que el autor de este software no puede, en ningún caso, ser considerado responsable por daños directos o indirectos, ni por ningún otro daño de ningún tipo, como resultado del uso de este software o la imposibilidad de Úsalo por cualquier motivo.',
    'step' => 'Paso',
