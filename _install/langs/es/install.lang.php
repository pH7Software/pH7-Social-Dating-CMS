...
$LANG = [
    ...
    'install_access_not_configured' => 'Instalador bloqueado. Desde el directorio pH7Builder, ejecute el comando 1 y recargue. Si el token ya existe, use el comando 2.',
