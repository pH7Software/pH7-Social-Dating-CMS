...
$LANG = array (
    ...
    <p>Для сообщений об ошибках, предложения, партнерство, участие в разработке программного обеспечения и / или перевода,
     и т.д., пожалуйста, посетите наш <a href="' . Controller::SOFTWARE_WEBSITE . '">веб-сайт</a>.</p>
    <p>---</p>
    <p>С уважением,</p>
