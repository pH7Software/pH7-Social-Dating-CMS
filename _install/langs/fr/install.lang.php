...
$LANG = [
    ...
    'install_access_not_configured' => 'L’accès à l’installation est verrouillé. Exécutez la commande ci-dessous depuis le dossier pH7Builder, puis rechargez cette page. Si la commande a déjà réussi, exécutez <code>chmod 0644 _install/data/caches/install-token.hash</code> afin que PHP puisse lire le hachage généré.',
