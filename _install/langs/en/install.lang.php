...
$LANG = array(
    ...
    'zendate_niche_desc' => 'By choosing the Social niche, only the Social modules will be enabled and the Social theme will be enabled by default.',
    'datelove_niche_desc' => 'By choosing the Dating niche, only the Dating modules will be enabled on your website and the Dating theme will be enabled by default.',
