...
$LANG = [
    ...
    'install_access_not_configured' => 'Installer access is locked. Run the command below from the pH7Builder directory, then reload this page. If the command already succeeded, run <code>chmod 0644 _install/data/caches/install-token.hash</code> so PHP can read the generated hash.',
