...
<div id="disclaimer-dialog">
    <div class="center">
        ...
        <p>
            <small>
                {lang 'By entering to "%site_url%", you are agreeing to the <a href="%0%" target="_blank" rel="nofollow noopener">Terms of Use</a> and <a href="%1%" target="_blank" rel="nofollow noopener">Privacy Policy</a>.', $terms_url, $privacy_url}
            </small>
        </p>
    </div>
</div>
