...
<form method="post" action="{$smarty.const.PH7_URL_SLUG_INSTALL}config_system">
    <fieldset>
        ...
        <p>
             <span class="mandatory">*</span> <label for="phone_id">{$LANG.phone_id}:</label><br />
        </p>

          <label class="container">US
               <input type="radio" id="US" name="US" value="{$smarty.session.val.phone_id|escape}" checked="checked">
               <span class="checkmark"></span>
          </label>
          <label class="container">UK
               <input type="radio" id="UK" name="UK" value="{$smarty.session.val.phone_id|escape}">
               <span class="checkmark"></span>
          </label>
          <label class="container">FR
               <input type="radio" id="FR" name="FR" value="{$smarty.session.val.phone_id|escape}">
               <span class="checkmark"></span>
          </label>
          <label class="container">EN
               <input type="radio" id="EN" name="EN" value="{$smarty.session.val.phone_id|escape}">
               <span class="checkmark"></span>
          </label>
          <p>
