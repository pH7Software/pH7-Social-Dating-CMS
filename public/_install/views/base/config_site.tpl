...
<form method="post" action="{$smarty.const.PH7_URL_SLUG_INSTALL}config_site">
    ...
    <input type="text" name="admin_username" id="admin_username" onfocus="if('administrator' == this.value) this.value='';" onblur="if ('' == this.value) this.value = 'administrator';" value="{$smarty.session.value.admin_username}" required="required" /></p>
    ...
    <input type="email" name="admin_login_email" id="admin_login_email" value="{$smarty.session.value.admin_login_email}" required="required" /></p>

    <p><span class="mandatory">*</span> <label for="admin_email">{$LANG.admin_email} :</label><br />
    <input type="email" name="admin_email" id="admin_email" value="{$smarty.session.value.admin_email}" required="required" /></p>

    <p><span class="mandatory">*</span> <label for="admin_feedback_email">{$LANG.admin_feedback_email} :</label><br />
    <input type="email" name="admin_feedback_email" id="admin_feedback_email" value="{$smarty.session.value.admin_feedback_email}" required="required" /></p>

    <p><span class="mandatory">*</span> <label for="admin_return_email">{$LANG.admin_return_email} :</label><br />
    <input type="email" name="admin_return_email" id="admin_return_email" value="{$smarty.session.value.admin_return_email}" required="required" /></p>

    <p><span class="mandatory">*</span> <label for="admin_first_name">{$LANG.admin_first_name} :</label><br />
    <input type="text" name="admin_first_name" id="admin_first_name" value="{$smarty.session.value.admin_first_name}" required="required" /></p>

    <p><span class="mandatory">*</span> <label for="admin_last_name">{$LANG.admin_last_name} :</label><br />
    <input type="text" name="admin_last_name" id="admin_last_name" value="{$smarty.session.value.admin_last_name}" required="required" /></p>
