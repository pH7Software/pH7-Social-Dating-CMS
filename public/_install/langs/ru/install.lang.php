...
$LANG = array (
    ...
    'bad_username' => 'Ваше имя пользователя является неправильным',
    ...
    'insecure_password' => 'Для вашей безопасности, ваш пароль должен отличаться от вашей личной информации (имя пользователя, имя и фамилию).',
    ...
    <p>Для сообщений об ошибках, предложения, партнерство, участие в разработке программного обеспечения и / или перевода, и т.д., пожалуйста, посетите наш <a href="' . Controller::SOFTWARE_WEBSITE . '">веб-сайт</a>.</p>
    <p>---</p>
    <p>С уважением,</p>
    ...
    'buy_copyright_license' => '<span class="gray">Пожизненная лицензия</span> <span class="right">Купить сейчас</span>',
    ...
    'buy_individual_ticket_support' => '<span class="gray">Полная поддержка билет на один месяц</span> <span class="right">Купить сейчас</span>',
