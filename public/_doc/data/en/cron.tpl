...
<p><strong>Attention, before continuing, you must change the secret word of cron (this is the parameter "secret_word" in the cron URL) with the yours in the administration panel to prevent others activate the cron without your knowledge.</strong></p>
