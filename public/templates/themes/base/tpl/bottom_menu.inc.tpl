       ...
       <div class="dropdown_menu ft_dm"><span class="dropdown_item_css">
       <a rel="nofollow" href="{{ $design->url('page','main','about') }}" class="dropdown_item" data-load="ajax">{@lang('About %site_name%')@}</a></span>
       ...
       <li><a href="{{ $design->url('blog','main','index') }}" title="{@lang('Our Blog')@}">{@lang('Blog')@}</a></li>
       ...
       <li class="dm_self"><span class="dropdown_item">{@lang('About')@}</span><i></i></li></ul></div> |

       <div class="dropdown_menu ft_dm"><span class="dropdown_item_css">
       <a rel="nofollow" href="{{ $design->url('page','main','help') }}" class="dropdown_item" data-load="ajax">{@lang('Help')@}</a></span>
       <ul class="show_dropdown">
       <li><a href="{{ $design->url('page','main','help') }}" title="{@lang('Help')@}" data-load="ajax">{@lang('Help')@}</a></li>
       <li><a href="{{ $design->url('page','main','faq') }}" title="{@lang('FAQ')@}" data-load="ajax">{@lang('FAQ')@}</a></li>
       ...
       <li class="dm_self"><span class="dropdown_item">{@lang('Help')@}</span><i></i></li></ul></div> |
