...
class CommentDesignCore
{
    ...
    public static function link($iId, $sTable)
    {
        ...
        if($iCommentNumber > 0)
        {
            ...
            echo ' - ', t('OR'), ' -  <a href="', UriRoute::get('comment','comment','read',$sTable.','.$iId), '">', $sCommentTxt, ' (', $iCommentNumber, ')</a> <a href="', UriRoute::get('xml','rss','xmlrouter','comment-'.$sTable.','.$iId), '"><img src="', PH7_URL_STATIC, PH7_IMG, 'icon/small-feed.png" alt="', t('RSS Feed'), '" /></a>';
        }
           echo '</p>';
    }
