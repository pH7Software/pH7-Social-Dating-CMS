...
class DeleteUserCoreFormProcessing extends Form
{
    ...
    public function __construct()
    {
        ...
        else
        {
            ...
            $sMessageHtml = $this->view->parseMail(PH7_PATH_SYS . 'globals/' . PH7_VIEWS . PH7_TPL_NAME . '/mails/sys/core/delete_account.tpl', DbConfig::getSetting('adminEmail'));
