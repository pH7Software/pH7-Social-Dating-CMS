...
class AffiliateCore extends UserCore
{
    ...
    public static function auth()
    {
        ...
        $bIsConnected = (((int)$oSession->exists('affiliate_id')) && $oSession->get('affiliate_ip') === Framework\Ip\Ip::get() && $oSession->get('affiliate_http_user_agent') === (new Browser)->getUserAgent());
        unset($oSession);
