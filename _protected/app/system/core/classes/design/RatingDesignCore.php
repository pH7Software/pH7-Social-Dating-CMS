...
class RatingDesignCore
{
    ...
    public static function voting($iId, $sTable, $sCssClass = '')
    {
        ...
        echo '<p class="', $sPHSClass, '_txt">', t('Score: %0% - Votes: %1%', $fRate, $aRating['votes']), '</p>';
         ...
         */
        if (!UserCore::auth()) {
            $sUrl = Uri::get('realestate', 'signup', 'step1', '?msg=' . t('You need to be a member for voting.'), false);
