...
class ReportCoreModel extends Framework\Mvc\Model\Engine\Model
{
    ...
    {
        $rStmt = Db::getInstance()->prepare('DELETE FROM' . Db::prefix('Report') . 'WHERE reportId=:reportId');
