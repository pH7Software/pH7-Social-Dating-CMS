...
class JoinForm
{
    public static function step1()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Your Country:'), 'country', Form::getCountryValues(DbTableName::AFFILIATE_COUNTRY), array('id' => 'str_country', 'value' => Geo::getCountryCode(), 'description' => t('Select the country where you are legally resident.'), 'required' => 1)));
