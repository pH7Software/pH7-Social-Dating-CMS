...
class AddAffiliateForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\CKEditor(t('Description:'), 'description', array('description'=>t('Description of the affiliated site(s).'), 'validation'=>new \PFBC\Validation\Str(10,2000), 'required' =>1)));
