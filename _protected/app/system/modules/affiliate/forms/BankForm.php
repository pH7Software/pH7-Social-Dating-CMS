...
class BankForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Email($sHtmlPayPalIcon . t('Your Bank Account:'), 'bank_account', ['id' => 'email_paypal', 'onblur' => 'CValid(this.value,this.id)', 'description' => t('Your Bank Account (PayPal Email Address).'), 'value' => self::getAffiliateBankAccount($oHttpRequest), 'validation' => new \PFBC\Validation\BankAccount, 'required' => 1]));
