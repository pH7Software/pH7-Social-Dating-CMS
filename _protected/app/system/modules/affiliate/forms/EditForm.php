...
class EditForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Textarea(t('Description:'), 'description', array('id'=>'str_description', 'onblur'=>'CValid(this.value,this.id,10,1000)', 'description'=>t('Description of your site(s).'), 'title'=>t('Tell us about your site(s).'), 'value'=>$oAff->description, 'validation'=>new \PFBC\Validation\Str(10,1000), 'required'=>1)));
