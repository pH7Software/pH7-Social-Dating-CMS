<div class="center">
    ...
    {else}
        <p class="bold red">{lang 'WARNING: If you delete your account you will not receive your commission.'}<br />
        {lang 'Are you really sure you want to delete your account?'}</p>
        <ul>
            <li>
