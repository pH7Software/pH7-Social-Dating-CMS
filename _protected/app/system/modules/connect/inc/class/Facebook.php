...
class Facebook extends Api implements IApi
{
    ...
    protected function setLoginUrl(FacebookRedirectLoginHelper $oHelper)
    {
        $this->sUrl = $oHelper->getLoginUrl([
            'scope' => 'email,user_birthday,user_relationships,user_relationship_details,user_hometown,user_location,user_interests,user_about_me,user_likes,user_website'
        ]);
    }
