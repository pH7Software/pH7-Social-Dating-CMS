<div class="box-left col-md-3 col-lg-3 col-xl-2">
    <div role="search" class="design-box">
        <h2>{lang 'Search Buyers'}</h2>
        {{ SearchQuickBuyerForm::display(PH7_WIDTH_SEARCH_FORM) }}
    </div>
</div>
    ...
    {else}
        {each $user in $users}
            <div class="thumb_photo">
                ...
                {{ $avatarDesign->get($user->username, $user->firstName, $user->sex, AvatarDesignCore::BROWSE_BUYER_AVATAR_SIZE, false) }}
                <p class="cy_ico">
