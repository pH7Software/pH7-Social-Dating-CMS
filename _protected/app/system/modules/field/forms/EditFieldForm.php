...
class EditFieldForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Number(t('Length Field:'), 'length', ['description' => t('Length of the field in numeric number (e.g., 150).') . '<br /><small>' . t('Note: The field will always have the default value (%0%) even if you updated to another value. Your change is saved, but cannot be retrieve on the form.', FieldModel::MAX_VARCHAR_LENGTH) . '</small>', 'value' => FieldModel::MAX_VARCHAR_LENGTH, 'required' => 1]));
