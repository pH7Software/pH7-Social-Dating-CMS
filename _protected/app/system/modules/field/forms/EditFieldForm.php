...
class EditFieldForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Field Type:'), 'type', array('textbox' => t('Text Box'), 'number' => t('Number')), array('description' => '<small>' . t('Note: The field will always have the default value even if you updated to another value. Your change is saved, but cannot be retrieve on the form.') . '</small>', 'value' => 'textbox', 'required' => 1)));
