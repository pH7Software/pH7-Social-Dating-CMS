<div class="middle" itemscope="itemscope" itemtype="http://schema.org/BlogPosting">
    {if empty($error)}
        <article>
            ...
            <div class="left">
                <h4 itemprop="author">
                    {lang 'Author: <a href="%0%" data-load="ajax">%1%</a>', (new UserCore)->getProfileSignupLink($post->username, $post->firstName, $post->sex), $post->firstName}
                </h4>
