...
{@if(empty($error))@}
  ...
  <div class="left"><h4>{@lang('Author: <a href="%0%">%1%</a>.', (new UserCore)->getProfileSignupLink($post->username, $post->firstName, $post->sex), $post->firstName)@}</h4>{{ NoteDesign::thumb($post) }}</div>
