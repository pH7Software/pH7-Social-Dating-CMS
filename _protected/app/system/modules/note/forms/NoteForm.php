...
class NoteForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\HTMLExternal('<script src="' . PH7_URL_STATIC . PH7_JS . 'validate.js"></script><script src="' . PH7_URL_TPL_SYS_MOD . 'note/' . PH7_TPL . PH7_TPL_MOD_NAME . PH7_DS . PH7_JS . 'common.js"></script>'));
        $oForm->render();
    }
