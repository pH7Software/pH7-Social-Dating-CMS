...
class EditForumForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Textarea(t('Description:'), 'description', ['value' => $oForumData->description, 'id' => 'str_description', 'required' => 1, 'onblur' => 'CValid(this.value,this.id,4,190)', 'validation' => new \PFBC\Validation\Str(4, 190)]));
