<?php
/**
 * @title          Picture Form Processing Class
 *
...
class PictureFormProcessing extends Form
{
    ...
    public function __construct()
    {
        ...
        HeaderUrl::redirect(UriRoute::get('picture', 'main', 'album', $this->session->get('member_username') . ',' . $sAlbumTitle . ',' . $iAlbumId), $sMsg);
    }
