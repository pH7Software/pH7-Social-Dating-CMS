...
class AddFakeProfilesForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Number:'), 'num', array(1, 5, 10, 15, 25), array('description' => t('Number of fake profiles to add in the same time.'), 'required'=>1)));
