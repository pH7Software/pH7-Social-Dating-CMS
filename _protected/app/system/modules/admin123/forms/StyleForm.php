...
class StyleForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Textarea(t('Your custon CSS code'), 'code', ['value' => (new Design)->customCode('css'), 'description' => t("WARNING! Here you don't have to add %0% tags.", '<b><i>&lt;style&gt;&lt;/style&gt;</i></b>'), 'style' => 'height:35rem']));
