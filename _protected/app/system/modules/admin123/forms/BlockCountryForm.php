...
class BlockCountryForm
{
     ...
     * @return array
     */
    private static function getBlockedCountries()
    {
        $aBlockedCountries = [];

        $oBlockedCountries = (new BlockCountryModel)->getBlockedCountries();
        foreach ($oBlockedCountries as $oCountry) {
