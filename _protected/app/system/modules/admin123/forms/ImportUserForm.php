...
class ImportUserForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\HTMLExternal(t('Import members into your site from a <strong><abbr title="Comma Separated Values">CSV</abbr></strong> file. You can find database users <strong><a href="%0%">here</a></strong>.', 'http://www.saledatingprofiles.com/?from=hizup.com')));
        ...
        $oForm->addElement(new \PFBC\Element\File(t('CSV file:'), 'csv_file', array('required'=>1)));
