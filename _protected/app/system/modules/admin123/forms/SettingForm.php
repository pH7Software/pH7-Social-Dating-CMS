...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Enable/Disable Two-Factor Admin Authentication '), '2factor_auth', array('1' => t('Enable'), '0' => t('Disable')), array('description' => t('To use it, you have first to download a "Two-Factor Authentication" app such as <a href="%0%">Android</a>/<a href="%1%">iOS</a> Google Authenticator.', 'https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2', 'https://itunes.apple.com/en/app/google-authenticator/id388497605'), 'value' => DbConfig::getSetting('2FactorAuth'), 'required' => 1)));
