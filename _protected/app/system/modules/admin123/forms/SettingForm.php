...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new Select(t('Top Navbar Menu Design'), 'navbar_type', ['default' => t('White (default)'), 'inverse' => t('Dark')], ['value' => DbConfig::getSetting('navbarType'), 'required' => 1]));
