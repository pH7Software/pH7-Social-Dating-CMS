...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Cookie Consent Bar:'), 'cookie_consent_bar', array(1 => t('Enable'), 0 => t('Disable')), array('description' => t('Enable the cookie consent bar to prevent your users that your site uses cookies. This feature is mostly useful for EU users, to comply with EU Cookie Law.'), 'value' => DbConfig::getSetting('cookieConsentBar'), 'required' => 1)));
