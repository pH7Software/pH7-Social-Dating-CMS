...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Site Status:'), 'site_status', array(DbConfig::ENABLE_SITE => t('Enable'), DbConfig::MAINTENANCE_SITE => t('Maintenance')), array('description' => t("Maintenance mode is useful if you are working on your website or update it. Logged in admins and admin panel won't be affected by the maintenance page."), 'value' => DbConfig::getSetting('siteStatus'), 'required' => 1)));
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Show "Powered By" link in footer:'), 'display_powered_by_link', array(1 => t('Enable (recommended)'), 0 => t('Disable')), array('description' => t('Are you proud of pH7CMS brand? Are you proud to say your dating app has been made by the European Leader Dating software?'), 'value' => DbConfig::getSetting('displayPoweredByLink'), 'required' => 1)));
