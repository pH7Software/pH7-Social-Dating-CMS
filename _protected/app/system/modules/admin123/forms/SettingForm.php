...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Date of Birth user field type:'), 'is_user_age_range_field', ['1' => t('Age Range (without month and day of birth )'), '0' => t('Date-picker calendar (full date of birth)')], ['value' => DbConfig::getSetting('isUserAgeRangeField'), 'required' => 1]));
