...
class AddUserForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Username(t('Nickname:'), 'username', array('required' => 1, 'validation' => new \PFBC\Validation\Username)));
        ...
        $oForm->addElement(new \PFBC\Element\Radio(t('Gender:'), 'sex', array('female' => t('Woman'), 'male' => t('Man'), 'couple' => t('Couple')), array('value' => 'female', 'required' => 1)));
        $oForm->addElement(new \PFBC\Element\Checkbox(t('Looking for:'), 'match_sex', array('male' => t('Man'), 'female' => t('Woman'), 'couple' => t('Couple')), array('value' => 'male', 'required' => 1)));
