                ...
                {each $user in $browse}
                    <tr>
                        ...
                        <td class="small">
                            ...
                            <a href="{{ $design->url('realestate','setting','design',"$user->profileId,$user->username,$user->firstName,$user->sex", false) }}" title="{lang "Edit the Wallpaper of the User's Profile Page"}">{lang 'Edit Wallpaper'}</a>
                            {if $is_mail_enabled}
