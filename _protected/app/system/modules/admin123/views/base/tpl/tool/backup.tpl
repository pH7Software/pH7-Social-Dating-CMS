  ...
  <table class="center">
    ...
    <tr>
      <td class="border vs_padd">
        ...
        <input type="radio" name="backup_type" value="server" id="server" /></label>
      </td>
    </tr>
    ...
    <tr>
      <td class="border vs_padd">
        <label for="client">{@lang('Download SQL file to your desktop')@}
        <input type="radio" name="backup_type" value="client" id="client" /></label>
      </td>
    </tr>
    ...
    <tr>
      <td class="border vs_padd">
        <label for="show">{@lang('Show on the screen')@}
        <input type="radio" name="backup_type" value="show" id="show" /></label>
    ...
    <tr>
      <td class="border vs_padd">
        ...
        {@foreach($aDumpList as $dumpFile)@}
          <option value="{dumpFile}">{dumpFile}</option>
        {@/foreach@}
        </select>
        </label>

        <input type="submit" name="restore_dump" value="{@lang('Restore data from dump')@}" /> &nbsp; &bull; &nbsp; <input type="submit" name="remove_dump" value="{@lang('Delete dump')@}" />
      </td>
    </tr>
