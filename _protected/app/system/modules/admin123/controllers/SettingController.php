 ...
 */
namespace PH7;
use PH7\Framework\Navigation\Page, PH7\Framework\Url\HeaderUrl, PH7\Framework\Mvc\Router\UriRoute;
...
class SettingController extends Controller
{
    ...
    {
        HeaderUrl::redirect(UriRoute::get(PH7_ADMIN_MOD, 'setting', 'general'));
    }
    ...
    public function metaMain()
    {
        ...
        if (!in_array(substr($this->httpRequest->currentUrl(), -5), $aLangs)) {
            HeaderUrl::redirect(UriRoute::get(PH7_ADMIN_MOD, 'setting', 'metamain', PH7_LANG_NAME, false));
        }
        unset($aLangs);
