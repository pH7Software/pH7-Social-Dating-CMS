...
class MainController extends Controller
{
    ...
    protected function checkUpdates()
    {
        if (Version::isUpdateEligible()) {
            ...
            $sMsg .= '<br /><br />';
            $sMsg .= t('Read <a href="%0%" target="_blank" rel="noopener">here</a> to learn how to upgrade your site, step-by-step. Once you follow the steps, run the upgrade wizard <a href="%1%" target="_blank" rel="noopener">here</a>.', Version::UPGRADE_DOC_URL, PH7_URL_ROOT . 'asset/file/Upgrade');
