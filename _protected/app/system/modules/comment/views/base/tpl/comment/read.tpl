...
{{ $absolute_url = Framework\Mvc\Router\UriRoute::get('comment','comment','post',"$table,$com->commentId") }}
{{ $relative_url = Framework\Mvc\Router\UriRoute::get('comment','comment','read',"$table,$com->recipient") . '#' . $com->commentId }}
