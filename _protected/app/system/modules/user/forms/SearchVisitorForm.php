...
class SearchVisitorForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Search(t('Find Search a Visitor of "%0%"', $sUsername), 'looking', array('description' => t('Enter the First/Last Name, Username, Email or ID of your friend.'))));
