...
class JoinFormProcessing extends Form
{
    ...
    public function step2()
    {
        ...
        // WARNING FOT "matchSex" FIELD: Be careful, you should use the \PH7\Framework\Mvc\Router\UriRoute::ONLY_XSS_CLEAN constant otherwise the post method of the HttpRequest class removes the tags special
