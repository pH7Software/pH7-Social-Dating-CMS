...
class JoinForm
{
    public static function step1()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Username(t('Your Nickname'), 'username', array('placeholder' => t('Nickname'), 'description' => PH7_URL_ROOT . '<strong><span class="your-user-name">' . t('your-user-name') . '</span><span class="username"></span></strong>' . PH7_PAGE_EXT, 'id' => 'username', 'required' => 1, 'validation' => new \PFBC\Validation\Username)));
    ...
    public static function step2()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Your Country'), 'country', (new UserCoreModel)->getCountries(), array('id' => 'str_country', 'value' => Geo::getCountryCode(), 'required' => 1)));
