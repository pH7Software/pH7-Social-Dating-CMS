...
class AdminBlogForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Textbox(t('The language of the article:'), 'lang_id', ['description' => t('e.g., "en", "fr", "es", "js"'), 'value' => PH7_LANG_CODE, 'pattern' => '[a-z]{2}', 'validation' => new \PFBC\Validation\Str(2, 2), 'required' => 1]));
