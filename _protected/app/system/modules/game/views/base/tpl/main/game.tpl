<div class="center">
    {if empty($error)}
        ...
        <p>
            <a class="m_button" href="{{ $design->url('game','main','download',$game->gameId) }}">{lang 'Download this game'}</a>
        </p>
        ...
        {if AdminCore::auth()}
            <div>
                <a class="m_button" href="{{ $design->url('game','admin','edit',"$game->title,$game->gameId") }}">{lang 'Edit this Game'}</a> |
