...
This Privacy Policy governs the manner in which {site_name} collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="{url_root}">{url_root}</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by {site_name}.<br><br>
...
{site_name} collects and uses Users personal information for the following purposes:<br>
<ul>
...
{site_name} has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>

<b>Your acceptance of these terms</b><br><br>

By using this Site, you signify your acceptance of this policy and <a href="{{ $design->url('page','main','terms') }}">terms of service</a>.<br />
...
privacy practices of this site, please contact us via our &quot;<a href="{{ $design->url('contact','contact','index') }}" title="Contact Us">contact form</a>&quot;<br>

<a href="{url_root}">{url_root}</a><br>
<br>
This document was last updated on January 26, 2012.<br><br>
