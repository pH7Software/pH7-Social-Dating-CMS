...
class MainController extends Controller
{
    ...
    public function faq()
    {
        $this->design->addCss(PH7_LAYOUT . PH7_SYS . PH7_MOD . $this->registry->module . PH7_DS . PH7_TPL . PH7_TPL_MOD_NAME . PH7_DS . PH7_CSS, 'faq.css');
    ...
    public function job()
    {
        ...
        $this->view->page_title = $this->sTitle;
        $this->view->meta_description = $this->sTitle;
        $this->view->h2_title = t('Careers, Jobs and Internships at %site_name%');
        $this->output();
    }
