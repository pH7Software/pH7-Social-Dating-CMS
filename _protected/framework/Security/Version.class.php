...
final class Version
{
    ...
    const KERNEL_VERSION_NAME = 'pOW'; // 1.0 and 1.1 branches were "pOH", 1.2 branch is now "pOW" and the new one should be "p[H]"
    const KERNEL_VERSION = '1.2.8';
    const KERNEL_BUILD = '1';
    const KERNEL_RELASE_DATE = '2015-01-05';
