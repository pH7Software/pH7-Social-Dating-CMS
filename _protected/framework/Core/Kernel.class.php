...
abstract class Kernel
{
    ...
    const SOFTWARE_ISSUE_URL = 'https://github.com/pH7Software/pH7-Social-Dating-CMS/issues/';
    ...
    const SOFTWARE_COPYRIGHT = '(c) 2011-2018, Pierre-Henry Soria. All Rights Reserved.';
