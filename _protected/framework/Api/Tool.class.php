...
class Tool
{
    ...
    {
        if (strcmp($oRequest->post('private_api_key'), $oConfig->values['ph7cms.api']['private_key']) === 0)
        {
            return in_array($oRequest->post('url'), $oConfig->values['ph7cms.api']['allow_domains']);
        }
        return false;
    }
