...
cd /tmp
curl -LO https://github.com/pH7Software/pH7-Social-Dating-CMS/releases/download/v19.3.1/pH7Builder-v19.3.1.zip
curl -LO https://github.com/pH7Software/pH7-Social-Dating-CMS/releases/download/v19.3.1/pH7Builder-v19.3.1.zip.sha256
sha256sum -c pH7Builder-v19.3.1.zip.sha256
unzip pH7Builder-v19.3.1.zip
cp -a pH7Builder-v19.3.1/. /var/www/ph7builder/
```

Run these commands as the `deploy` account, or replace that example account
with your normal non-root deployment user.

For a source checkout instead, clone tag `v19.3.1` and run:

```console
git clone --branch v19.3.1 --depth 1 https://github.com/pH7Software/pH7-Social-Dating-CMS.git pH7Builder-v19.3.1
cd pH7Builder-v19.3.1
...
```console
composer create-project ph7software/ph7builder:19.3.1 ph7builder --no-dev --prefer-dist
```
