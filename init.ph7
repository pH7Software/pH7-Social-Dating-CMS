...
if (!is_file(__DIR__ . '/_constants.php'))
    exit( (is_dir(__DIR__ . '/_install/') ? header('Location: _install/') : 'CONFIG FILE NOT FOUND! If you want to make a new installation, please re-upload _install/ folder and clear your database.') );
