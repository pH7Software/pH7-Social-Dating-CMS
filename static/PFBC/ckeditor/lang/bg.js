...
CKEDITOR.lang.bg = {
    ...
    textarea: {title: 'Параметри на текстовата област', cols: 'Колони', rows: 'Редове'},
    textfield: {
    ...
    hidden: {title: 'Параметри на скритото поле', name: 'Име', value: 'Стойност'},
    image: {
    ...
    smiley: {toolbar: 'Усмивка', title: 'Добави усмивка', options: 'Smiley Options'},
    ...
    font: {label: 'Шрифт', voiceLabel: 'Font', panelTitle: 'Шрифт'},
    fontSize: {label: 'Размер', voiceLabel: 'Font Size', panelTitle: 'Размер'},
    colorButton: {
