...
CKEDITOR.lang.eo = {
    ...
    textarea: {title: 'Atributoj de Teksta Areo', cols: 'Kolumnoj', rows: 'Vicoj'},
    textfield: {
    ...
    smiley: {toolbar: 'Mienvinjeto', title: 'Enmeti Mienvinjeton', options: 'Smiley Options'},
    ...
    justify: {left: 'Maldekstrigi', center: 'Centrigi', right: 'Dekstrigi', block: 'Ĝisrandigi Ambaŭflanke'},
    ...
    pasteText: {button: 'Interglui kiel Tekston', title: 'Interglui kiel Tekston'},
    templates: {
        button: 'Templates',
    ...
    font: {label: 'Tiparo', voiceLabel: 'Font', panelTitle: 'Tiparo'},
    fontSize: {label: 'Grando', voiceLabel: 'Font Size', panelTitle: 'Grando'},
    colorButton: {
