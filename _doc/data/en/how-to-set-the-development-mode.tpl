...
<p><span class="warning">WARNING, this procedure concerns only pH7CMS versions lower than 1.3.0</span> Since pH7CMS 1.3, this option is available in the admin panel -> Tools -> Environment Mode.</p>
