<h2>How to clear pH7CMS's caches?</h2>
...
<figure>
    <img src="{site_url}static/img/how-to-clear-caches.png" alt="How to clear the caches in pH7CMS's Admin Panel" title="How to clear the caches in pH7CMS's Admin Panel" />
