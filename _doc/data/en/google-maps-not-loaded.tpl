...
<figure>
    <img src="{site_url}static/img/google-map-not-loaded.png" alt="Google Maps went wrong, not loaded"
         title="Google Maps went wrong, not loaded"/>
    <figcaption>Google Maps now requires an API Key</figcaption>
</figure>

<figure>
    <img src="{site_url}static/img/google-map-api-form.png" alt="Google Maps Setting Form in pH7CMS Admin Panel"
